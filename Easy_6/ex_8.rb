...
# empty set, loop over all the num's in the array

# set = [] >> [1]
#         >> [1, 5]
#        >> [1, 5, 3]
# does set contain this iterative number?
# beauty of ds >> have certain properties that make them strong in different cases
# look up instantly with a set, hashed uniquely
# problem can become as large as input array
  # space complexity can become O(n)
